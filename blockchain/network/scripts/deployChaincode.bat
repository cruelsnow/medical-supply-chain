@echo off
REM =============================================================================
REM Medical Supply Chain Blockchain - Chaincode Deployment Script (Windows)
REM Function: Package, install, approve and commit chaincode to channel
REM =============================================================================

setlocal EnableDelayedExpansion

echo ============================================================
echo    Deploy Chaincode - supplychain
echo ============================================================
echo.
